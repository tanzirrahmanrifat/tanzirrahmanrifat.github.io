    ...
    data() {
      return {
        ...
        experienceItems: [{
         ...
         filters: ['All', 'HTML', 'WORDPRESS','EMAIL'],
         currentFilter: 'All',
         ...
         {
          id: 18,
          url: 'https://tanzirrifat.com/email2/',
          imgUrl: 'assets/images/portfolio/email/email2.png',
          title: {
            en: 'LABOR DAY'
          },
          date: {
         ...
         {
          id: 19,
          url: 'https://tanzirrifat.com/email1/',
          imgUrl: 'assets/images/portfolio/email/email1.png',
          title: {
            en: 'HOLIDAY'
          },
          date: {
         ...
         {
          id: 20,
          url: 'https://tanzirrifat.com/email3/',
          imgUrl: 'assets/images/portfolio/email/email3.png',
          title: {
            en: 'BUSINESS'
          },
          date: {
